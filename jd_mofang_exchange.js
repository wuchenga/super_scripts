...
[task_local]
#5魔方兑换
0 0 * * * https://gitee.com/SuperManito/scripts/raw/master/jd_mofang_exchange.js, tag=5魔方兑换, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "0 0 * * *" script-path=https://gitee.com/SuperManito/scripts/raw/master/jd_mofang_exchange.js,tag=5魔方兑换

===============Surge=================
5魔方兑换 = type=cron,cronexp="0 0 * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/SuperManito/scripts/raw/master/jd_mofang_exchange.js

============小火箭=========
5魔方兑换 = type=cron,script-path=https://gitee.com/SuperManito/scripts/raw/master/jd_mofang_exchange.js, cronexpr="0 0 * * *", timeout=3600, enable=true
*/
const $ = new Env('5魔方兑换');
