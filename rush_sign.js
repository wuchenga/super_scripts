...
Author：小埋
0 0 * * * rush_sign.js
https://lzkj-isv.isvjd.com/sign/signActivity?activityId=<id>
*/
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            $.activityUrl = `https://lzkj-isv.isvjcloud.com/sign/signActivity?activityId=${$.activityId}&venderId=${$.venderId}&adsource=tg_xuanFuTuBiao&lng=00.000000&lat=00.000000&sid=&un_area=`
